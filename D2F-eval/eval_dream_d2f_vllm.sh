...
lora_models=(
    "/home/xiongjing/resource_dir/models/D2F_Dream_Base_7B_Lora"
)
...
for lora_model in "${lora_models[@]}"; do
    ...
    for i in "${!HUMANEVAL_NSHOTS_ARRAY[@]}"; do
        ...
        CUDA_VISIBLE_DEVICES=3 accelerate launch --main_process_port ${accelerate_port} --num_processes 1 eval_dream_d2f_vllm.py --model dream_lora \
    ...
    #     fi
    #     CUDA_VISIBLE_DEVICES=3,4 accelerate launch --main_process_port ${accelerate_port} --num_processes 2 eval_dream_d2f_vllm.py --model dream_lora \
