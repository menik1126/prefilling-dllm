# D2F / Fast-dLLM ParallelComp Evaluation

This directory contains the cleaned evaluation code for the D2F / Dream /
Fast-dLLM ParallelComp long-context experiments. Historical backups, debug
...
General Dream/D2F evaluation helpers are kept in `eval_dream.py`,
`eval_infinitebench.py`, `eval_longbench_dream.py`, `d2f_model.py`, and
...
- model weights under `D2F-eval/model_weights/`
