...
from prefilling_dllm.utils.context import get_context_causal_lm, get_context_diffusion_lm
...
class ParallelLMHead(VocabParallelEmbedding):
    ...
    def forward(self, x: torch.Tensor):
        ...
        if self.tp_size > 1:
            # Use all_gather instead of gather so all ranks get the complete logits
