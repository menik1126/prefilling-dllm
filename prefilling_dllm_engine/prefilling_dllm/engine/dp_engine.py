...
class DPEngine:
    ...
    def __init__(self, model, **kwargs):
        ...
        # Optional overrides: kwargs['device_ids'] or env PREFILLING_DLLM_DEVICE_MAP
        override = None
        if 'device_ids' in kwargs and kwargs['device_ids']:
            override = list(kwargs['device_ids'])
        elif os.environ.get('PREFILLING_DLLM_DEVICE_MAP'):
            override = [int(x) for x in os.environ['PREFILLING_DLLM_DEVICE_MAP'].split(',') if x.strip() != '']
