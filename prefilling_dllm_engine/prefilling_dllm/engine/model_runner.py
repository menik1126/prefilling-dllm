...
from prefilling_dllm.engine.sequence import SequenceForCausalLM, SequenceForDiffusionLM, SequenceBase
from prefilling_dllm.models.auto_model import AutoModelLM
from prefilling_dllm.layers.sampler import AutoSampler
from prefilling_dllm.utils.checker import CHECK_SLOT_MAPPING
from prefilling_dllm.utils.context import (
        ...
        if self.world_size > 1:
            ...
            if dist.is_initialized():
                ...
                try:
                    ...
                    import tempfile
                    temp_file = f"/tmp/prefilling_dllm_shm_name_{os.getpid()}"
                ...
                while retry_count < max_retries:
                    try:
                        ...
                        import os
                        temp_file = f"/tmp/prefilling_dllm_shm_name_{os.getppid()}"  # Use parent process ID
